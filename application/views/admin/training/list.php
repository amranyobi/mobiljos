...
<?php
echo form_open(base_url('admin/lelang/proses'));
?>
<p class="btn-group">
  <a href="<?php echo base_url('admin/lelang/tambah') ?>" class="btn btn-success">
  <i class="fa fa-plus"></i> Tambah Lelang</a>&nbsp;
...
<tr class="odd gradeX">
    <td>
      <div class="mailbox-star text-center"><div class="text-center">
        <input type="checkbox" class="icheckbox_flat-blue " name="id_lelang[]" value="<?php echo $galeri->id_lelang ?>">
    ...
    <td><?php echo $galeri->judul_lelang ?>
    ...
    <td><?php echo number_format($galeri->harga_awal)?></td>
    <td>
      <div class="btn-group">
      <a href="<?php echo base_url('galeri/read/'.$galeri->id_lelang) ?>" 
      class="btn btn-success btn-xs" target="_blank"><i class="fa fa-eye"></i></a>

      <a href="<?php echo base_url('admin/galeri/edit/'.$galeri->id_lelang) ?>" 
      class="btn btn-warning btn-xs"><i class="fa fa-edit"></i></a>

       <a href="<?php echo base_url('admin/galeri/delete/'.$galeri->id_lelang) ?>" 
