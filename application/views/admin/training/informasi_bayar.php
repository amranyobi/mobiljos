...
<div class="row no-print">
  ...
  <div class="col-6">
    <a href="<?php echo base_url('admin/training/konfirmasi_bayar/')?>" rel="noopener" class="btn btn-primary"><i class="fa fa-check"></i>&nbsp;&nbsp;Konfirmasi Pembayaran</a>&nbsp;&nbsp;<a href="<?php echo base_url('admin/lelang/voucher_lelang')?>" class="btn btn-danger">Batal</a>
    <!-- <button type="button" class="btn btn-success float-right"><i class="far fa-credit-card"></i> Submit
      Payment
    </button>
    <button type="button" class="btn btn-primary float-right" style="margin-right: 5px;">
