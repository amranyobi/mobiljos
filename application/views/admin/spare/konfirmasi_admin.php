...
<tr class="odd gradeX">
    ...
    <td>
      <div class="btn-group">
      <a onClick="return confirm('Anda yakin akan mengkonfirmasi pembayaran?'); if (ok) return true; else return false"  href="<?php echo base_url('admin/lelang/proses_konfirmasi/'.$konf->id.'/'.$konf->id_voucher) ?>" 
