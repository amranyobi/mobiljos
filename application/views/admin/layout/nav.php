        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview" style="margin-left: 10px">
              ...
              <li class="nav-item"><a href="<?php echo base_url('admin/galeri/mobil_pesan') ?>" class="nav-link"><i class="fa fa-check-square-o nav-icon"></i><p>Data Mobil Pesan</p></a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview" style="margin-left: 10px">
              ...
              <li class="nav-item"><a href="<?php echo base_url('admin/lelang/tambah') ?>" class="nav-link"><i class="fa fa-plus nav-icon"></i><p>Tambah Lelang</p></a>
              </li>
              <!-- <li class="nav-item"><a href="<?php echo base_url('admin/kategori_galeri') ?>" class="nav-link"><i class="fa fa-tags nav-icon"></i><p>Kategori Galeri &amp; Banner</p></a>
              </li> -->
            ...
            <li class="nav-item has-treeview">
              <a href="#" class="nav-link">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item"><a href="<?php echo base_url('admin/lelang/voucher_lelang') ?>" class="nav-link"><i class="fa fa-money nav-icon"></i><p>Voucher Lelang</p></a>
                  </li>
                  <!-- <li class="nav-item"><a href="<?php echo base_url('admin/galeri') ?>" class="nav-link"><i class="fa fa-table nav-icon"></i><p>Data Galeri &amp; Banner</p></a>
                  </li> -->
                  <li class="nav-item"><a href="<?php echo base_url('admin/dasbor/lelang_berjalan') ?>" class="nav-link"><i class="nav-icon fa fa-group"></i><p>Ikut Lelang</p></a>
                  </li>
                  <!-- <li class="nav-item"><a href="<?php echo base_url('admin/kategori_galeri') ?>" class="nav-link"><i class="fa fa-tags nav-icon"></i><p>Kategori Galeri &amp; Banner</p></a>
                  </li> -->
                  </div>    
