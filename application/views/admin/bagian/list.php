...
<p>
  <div class="btn-group">
    <a href="<?php echo base_url('admin/bagian/tambah') ?>" class="btn btn-success btn-sm">
    <i class="fa fa-plus"></i> Tambah Baru</a>&nbsp;

    <button class="btn btn-info btn-sm" name="aktifkan" type="submit">
      <i class="fa fa-check"></i> Aktifkan
    </button>&nbsp;

    <button class="btn btn-warning btn-sm" name="non_aktifkan" type="submit">
