  ...
  <div class="card">
    <div class="register-box-body">
      <div class="login-logo">
        ...
        <br>
        <h2 style="font-weight: bold; font-size: 18px; margin-top: 20px;">Member Area - <?php echo $this->website->namaweb() ?></h2>
      </div>
       ...
       <!--  <div class="form-group">
        ...
        <div class="row">
          ...
          <div class="col-12" style="margin-top: 10px; text-align: center;">
            <a href="<?php echo base_url('member') ?>" class="btn btn-danger btn-sm btn-block">Batal</a>
          </div>
          <!-- /.col -->
        </div>
