...
class Service extends CI_Controller {
	...
	public function index()	{
		...
		$config['total_rows'] 		= count($this->spare_model->total_galeri());
		...
		$galeri 	= $this->spare_model->galeri($config['per_page'], $page);
		// End paginasi

		$data = array(	'title'		=> 'Lokasi Service & Sparepart - '.$site->namaweb,
						'deskripsi'	=> 'Lokasi Service & Sparepart - '.$site->namaweb,
						'keywords'	=> 'Lokasi Service & Sparepart - '.$site->namaweb,
